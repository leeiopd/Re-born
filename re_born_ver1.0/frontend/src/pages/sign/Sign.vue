    ...
    <center>
      <div>
        <img
          ...
          style="height: 8rem; margin-left: 5vw;"
          src="../../../public/reborn-logo.png"
        />
        <p
          style="color: #505050; font-size: 3rem; font-family: 'Poiret One', cursive; font-weight: bold; padding-top: 2vh;"
        >Re-born</p>
      </div>
      <!-- login provider -->
